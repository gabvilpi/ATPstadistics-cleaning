...
#NN = nnet(frml, size = length(nms)*2, data = entrenamiento, rang = 0.5, maxit=200, decay = 0, MaxNWts = 100000)
NN = nnet(entrenamiento[,1:56],entrenamiento[,57],size = length(nms)*2,rang = 0.5, maxit=200, decay = 0, MaxNWts = 100000,linout=T)
...
table(entrenamiento[,57],salida_entrenamiento)
