...
## C?digo: Hay que adjuntar el c?digo, preferiblemente en R, con el que se ha realizado la limpieza, an?lisis y representaci?n de los datos. Si lo prefer?s,
tambi?n pod?is trabajar en Python. 


Hemos obtenido un $R^2$ con valor 0.7958, por lo que nuestro modelo est? cerca de ajustarse a la totalidad, ya que el valor m?ximo de $R^2$ es 1.
