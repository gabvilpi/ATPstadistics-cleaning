...
#frml <- "ganador ~ Varianza_Serve_Rating_1"
NN = neuralnet(frml,entrenamiento, hidden= c(as.integer(length(nms)/2),as.integer(length(nms)/4)), linear.output = TRUE)
