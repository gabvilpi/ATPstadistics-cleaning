...
Antes de realizar el análisis de los datos, debemos seleccionar del dataset aquellos atribrutos que nos parezcan relevantes para construir nuestro modelo. Nosotros hemos decidido eliminar del dataset los atributos con el número total de juegos al servicio y al restoya que, a priori, no nos aportan información relevante sobre el rendimiento de cada jugador.
...
Una vez generado el dataset con las estimaciones, procedemos a generar el modelo y a validar su exactitud.
